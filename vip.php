...
<main class="main_vip">
    <link rel="stylesheet" href="assets/css/style_vip.scss">
    ...
    <div class="vip">
        ...
        <img id="img_vip" src="assets/img/Perso2.png" alt="vip">

        <div class="contour_vip"></div>
    ...
    <div class="vipPlus">
        ...
        <img id="img_vipPlus" src="assets/img/Perso1.png" alt="vip+">

        <div class="contour_vipPlus"></div>
